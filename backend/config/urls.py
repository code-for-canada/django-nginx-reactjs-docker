...
from views import views, database_check_view, test_meta_data_view, test_is_public
...
urlpatterns = [
    ...
    url(r"^api/test-is-public",
        test_is_public.TestIsPublic.as_view()),
    url(r"^api/test-is-public/(?P<test_name>.+)/$",
        test_is_public.TestIsPublic.as_view()),
