...
def upload_emib_sample(apps, schema_editor):
    ...
    item_text.objects.using(db_alias).bulk_create([
        ...
        item_text(item_id=i_q1_from,
                  text_detail="Serge Duplessis (QA Analyst)", language=l_english),
        item_text(item_id=i_q1_from, text_detail="Serge Duplessis (Analyste de l’assurance de la qualité)", language=l_french),
        item_text(item_id=i_q1_to,
                  text_detail="Claude Huard (Quality Assurance Manager - You)", language=l_english),
        item_text(item_id=i_q1_to,
                  text_detail="Claude Huard (Gestionnaire, Assurance de la qualité - vous)", language=l_french),
        ...
        item_text(item_id=i_q2_from,
                  text_detail="Marina Richter (QA Analyst)", language=l_english),
        item_text(item_id=i_q2_from, text_detail="Marina Richter (Analyste de l’assurance de la qualité)", language=l_french),
        ...
        item_text(item_id=i_q3_from,
                  text_detail="Charlie Wang (QA Analyst)", language=l_english),
        item_text(item_id=i_q3_from, text_detail="Charlie Wang (Analyste de l’assurance de la qualité)", language=l_french),
